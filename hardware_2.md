...
| :--: | :-------: | :----------: | :---------------------: |
|  1   |   nand    |    u,op1     |        11111100         |
|  2   |   nand    |   !u,!op1    |        00111111         |
|  3   |   nand    |    !u,op0    |        10101111         |
|  4   |   nand    |   op1,op0    |        11101110         |
|  5   |   nand    |    u,op0     |        11111010         |
|  6   |   nand    |    u,!op1    |        11110011         |
|  7   |    and    |    u,!zx     |            -            |
|  8   |   nand    |    1,!op0    |        01010111         |
|  9   |   nand    |     4,8      |        10111001         |
|  10  |   nand    |     1,4      |      **00010011**       |
|  11  |   nand    |     1,5      |        00000111         |
|  12  |   nand    |     14,4     |        10010111         |
|  13  |   nand    |     2,9      |      **11000110**       |
|  14  |   nand    |     13,3     |      **01111001**       |
|  15  |    and    |     4,11     |        00000110         |
|  16  |   nand    |     6,12     |      **01101100**       |
|  17  | select !s | !zx,zx,16,10 |            -            |
|  18  |    and    |    7,!sw     |            -            |
|  19  |    and    |     7,sw     |            -            |
|  20  | select !s | !zx,zx,13,14 |            -            |
|  21  | select !s | sw,!sw,14,17 |            -            |
|  22  | select !s | !sw,sw,14,17 |            -            |

> 注： $13,16,14,10$ 号元件分别表示 $q3',q2',q1',q0'$ 。

输出 $cx,cy,q3,q2,q1,q0,y$ 分别接 $18,19,20,21,22,10,15$ 号元件。
...
合计 $5+34+20\times 15+15=354$ 个与非门。
